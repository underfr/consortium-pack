...
const CONSORTIUM_QUEST_TASKS = {
  ...
  // ---- GENERATED by tools/quests/build.mjs (authored chapters): edit tools/quests/authored, not these rows ----
  '5C11000000000071': { kind: 'run', family: 'consortium:kinetic_assembly', units: 4 }, // Board Order: Kinetic Assembly
  '5C110000000000D1': { kind: 'run', family: 'consortium:provisions_crate', units: 5 }, // Board Order: Provisions Crate
  '5C12000000000071': { kind: 'run', family: 'consortium:steel_manifold', units: 8 }, // Board Order: Steel Manifold
  '5C120000000000D1': { kind: 'run', family: 'consortium:capacitor_bank', units: 7 }, // Board Order: Capacitor Bank
  '5C12000000000121': { kind: 'run', family: 'consortium:steam_regulator', units: 5 }, // Board Order: Steam Regulator
  '5C13000000000061': { kind: 'run', family: 'consortium:refinery_control_unit', units: 8 }, // Board Order: Refinery Control Unit
  '5C130000000000B1': { kind: 'run', family: 'consortium:fuel_cartridge', units: 7 }, // Board Order: Fuel Cartridge
  '5C13000000000101': { kind: 'run', family: 'consortium:data_crystal', units: 7 }, // Board Order: Data Crystal
  '5C14000000000061': { kind: 'run', family: 'consortium:guidance_module', units: 6 }, // Board Order: Orbital Guidance Module
  '5C140000000000B1': { kind: 'run', family: 'consortium:reforged_plate', units: 7 }, // Board Order: Reforged Alloy Plate
  '5C14000000000101': { kind: 'run', family: 'consortium:pattern_matrix', units: 6 }, // Board Order: Pattern Matrix
  '5C15000000000061': { kind: 'run', family: 'consortium:fusion_injector', units: 3 }, // Board Order: Fusion Injector
  '5C150000000000B1': { kind: 'run', family: 'consortium:cryo_core', units: 3 }, // Board Order: Cryo Core
  '5C15000000000101': { kind: 'run', family: 'consortium:singularity_housing', units: 3 }, // Board Order: Singularity Housing
  // ---- END GENERATED ----
}
...
const CONSORTIUM_QUEST_REWARDS = {
  ...
  // ---- GENERATED by tools/quests/build.mjs (authored chapters): edit tools/quests/authored, not these rows ----
  '5C20000000000144': { kind: 'cc', check: { c: 'item', item: 'create:mechanical_arm' }, cents: 1500, reason: 'diploma:dept_create' }, // Kinetics Diploma
  '5C21000000000124': { kind: 'cc', check: { c: 'item', item: 'mekanism:elite_control_circuit' }, cents: 1500, reason: 'diploma:dept_mekanism' }, // Processing Diploma
  '5C22000000000124': { kind: 'cc', check: { c: 'item', item: 'ae2:pattern_provider' }, cents: 2000, reason: 'diploma:dept_ae2' }, // Storage Diploma
  '5C23000000000124': { kind: 'cc', check: { c: 'item', item: 'immersiveengineering:capacitor_hv' }, cents: 2000, reason: 'diploma:dept_ie' }, // Heavy Engineering Diploma
  '5C240000000000E4': { kind: 'cc', check: { c: 'item', item: 'powah:reactor_blazing' }, cents: 1500, reason: 'diploma:dept_powah' }, // Power Diploma
  '5C250000000000E4': { kind: 'cc', check: { c: 'item', item: 'ad_astra:tier_2_rocket' }, cents: 2500, reason: 'diploma:dept_adastra' }, // Orbital Diploma
  '5C260000000000D4': { kind: 'cc', check: { c: 'item', item: 'apotheosis:augmenting_table' }, cents: 2000, reason: 'diploma:dept_combat' }, // Security Diploma
  '5C270000000000C4': { kind: 'cc', check: { c: 'item', item: 'productivemetalworks:foundry_tap' }, cents: 1500, reason: 'diploma:dept_metalworks' }, // Foundry Diploma
  '5C280000000000B4': { kind: 'cc', check: { c: 'item', item: 'consortium:provisions_crate' }, cents: 1000, reason: 'diploma:dept_kitchen' }, // Kitchen Diploma
  '5C290000000000D4': { kind: 'cc', check: { c: 'item', item: 'sophisticatedbackpacks:diamond_backpack' }, cents: 1500, reason: 'diploma:dept_storage' }, // Logistics Diploma
  '5C2A0000000000E4': { kind: 'cc', check: { c: 'item', item: 'mekanismadditions:white_plastic_glow' }, cents: 1000, reason: 'diploma:dept_building' }, // Architecture Diploma
  '5C2B000000000094': { kind: 'cc', check: { c: 'item', item: 'darkutils:redstone_randomizer' }, cents: 1000, reason: 'diploma:dept_workshop' }, // Workshop Diploma
  '5C11000000000064': { kind: 'cc', check: { c: 'item', item: 'consortium:kinetic_assembly' }, cents: 500, reason: 'product:kinetic_assembly:first' }, // First Kinetic Assembly
  '5C110000000000C4': { kind: 'cc', check: { c: 'item', item: 'consortium:provisions_crate' }, cents: 500, reason: 'product:provisions_crate:first' }, // First Provisions Crate
  '5C12000000000064': { kind: 'cc', check: { c: 'item', item: 'consortium:steel_manifold' }, cents: 1500, reason: 'product:steel_manifold:first' }, // First Steel Manifold
  '5C120000000000C4': { kind: 'cc', check: { c: 'item', item: 'consortium:capacitor_bank' }, cents: 1500, reason: 'product:capacitor_bank:first' }, // First Capacitor Bank
  '5C12000000000114': { kind: 'cc', check: { c: 'item', item: 'consortium:steam_regulator' }, cents: 1500, reason: 'product:steam_regulator:first' }, // First Steam Regulator
  '5C13000000000054': { kind: 'cc', check: { c: 'item', item: 'consortium:refinery_control_unit' }, cents: 2000, reason: 'product:refinery_control_unit:first' }, // First Refinery Control Unit
  '5C130000000000A4': { kind: 'cc', check: { c: 'item', item: 'consortium:fuel_cartridge' }, cents: 2000, reason: 'product:fuel_cartridge:first' }, // First Fuel Cartridge
  '5C130000000000F4': { kind: 'cc', check: { c: 'item', item: 'consortium:data_crystal' }, cents: 2000, reason: 'product:data_crystal:first' }, // First Data Crystal
  '5C14000000000054': { kind: 'cc', check: { c: 'item', item: 'consortium:guidance_module' }, cents: 2500, reason: 'product:guidance_module:first' }, // First Orbital Guidance Module
  '5C140000000000A4': { kind: 'cc', check: { c: 'item', item: 'consortium:reforged_plate' }, cents: 2500, reason: 'product:reforged_plate:first' }, // First Reforged Alloy Plate
  '5C140000000000F4': { kind: 'cc', check: { c: 'item', item: 'consortium:pattern_matrix' }, cents: 2500, reason: 'product:pattern_matrix:first' }, // First Pattern Matrix
  '5C15000000000054': { kind: 'cc', check: { c: 'item', item: 'consortium:fusion_injector' }, cents: 4000, reason: 'product:fusion_injector:first' }, // First Fusion Injector
  '5C150000000000A4': { kind: 'cc', check: { c: 'item', item: 'consortium:cryo_core' }, cents: 4000, reason: 'product:cryo_core:first' }, // First Cryo Core
  '5C150000000000F4': { kind: 'cc', check: { c: 'item', item: 'consortium:singularity_housing' }, cents: 4000, reason: 'product:singularity_housing:first' }, // First Singularity Housing
  '5C15000000000114': { kind: 'title', check: { c: 'closing', runs: [{ family: 'consortium:kinetic_assembly', units: 1 }, { family: 'consortium:provisions_crate', units: 1 }, { family: 'consortium:steel_manifold', units: 1 }, { family: 'consortium:capacitor_bank', units: 1 }, { family: 'consortium:steam_regulator', units: 1 }, { family: 'consortium:refinery_control_unit', units: 1 }, { family: 'consortium:fuel_cartridge', units: 1 }, { family: 'consortium:data_crystal', units: 1 }, { family: 'consortium:guidance_module', units: 1 }, { family: 'consortium:reforged_plate', units: 1 }, { family: 'consortium:pattern_matrix', units: 1 }, { family: 'consortium:fusion_injector', units: 1 }, { family: 'consortium:cryo_core', units: 1 }, { family: 'consortium:singularity_housing', units: 1 }] }, title: 'master_fabricator', text: 'Master Fabricator' }, // Master Fabricator
  // ---- END GENERATED ----
}
