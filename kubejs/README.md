...
folder in the pack. `server_scripts/` holds the economy locks (`economy_locks.js`: chunk loader, Waystones Warp Stone, IE brass, the foundry's ore-block melting cut to 2x since pack 0.11.0
